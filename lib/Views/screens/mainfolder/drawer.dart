...
class _DrawerScreenState extends State<DrawerScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    log("From Drawer to build usp  ${usp.name}  From Drawer to build sp ${sp.name} ");
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: res_width * 0.55,
                          child: Text(usp.email.toString() == "null" ? sp.name.toString() : sp.email.toString(),
                              style: TextStyle(fontFamily: '', fontSize: 15 * textScaleFactor, color: Colors.black),
                              overflow: TextOverflow.ellipsis,
                              maxLines: 1,
                              ),
                        )
                  ...
                  children: [
                    ...
                    Column(
                      ...
                      children: [
                        ...
                        SizedBox(
                          width: res_width * 0.55,
                          child: Text(usp.email.toString(), style: TextStyle( fontSize: 15 * textScaleFactor, color: Colors.black),
                          overflow: TextOverflow.ellipsis,
                          maxLines: 1,
                          ),
                          )
