...
import 'package:jared/model/getAllProductsModel.dart';
                ...
                isError
                    ...
                    : isLoading
                        ...
                        : emptyData
                            ...
                            results.length == 0 ? Center(child: Text("No Product Found")) 
                                ...
                                return GridView.builder(
                                  ...
                                  itemBuilder: (context, index) {
                                    ...
                                    return GestureDetector(
                                      onTap: () {
                                        print(
                                            "PRODUCT ID : ======> ${results[index].id.toString()}");
                                        Get.to(routeName: "PD",() => ProductDetailScreen(
                                            results[index].id,
                                            results[index].name,
                                            results[index].price,
                                            results[index].stars,
                                            AppUrl.baseUrlM + results[index].image.toString(),
                                                ...
                                                decoration: BoxDecoration(
                                                    image: DecorationImage(
                                                        image: NetworkImage(AppUrl
                                                                .baseUrlM + results[index].image.toString()
                                                           ))),
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.all(
